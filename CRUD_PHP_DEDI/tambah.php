...
<html>
<head>
	<title>CRUD PHP TUGAS WEB PROGRAMMING 2</title>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container">
			...
			<button class="navbar-toggler" type="button" user-toggle="collapse" user-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
	...
	<div class="container" style="margin-top:20px">
		<h2><font color=black>Tambah Data</color></h2>
		...
		if(isset($_POST['submit'])){
			...
			if (empty(nama) || empty(username) || empty(password) || empty(email)) {
				echo " <strong> Tolong Isi Data! </strong>";
			}else{
			}
		}
